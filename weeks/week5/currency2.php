...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(empty($_POST['email'])) {
        echo span('Please fill out your email!');
    }

    if(empty($_POST['amount'])) {
        echo span('Please fill out your amount! A "Zero" amount will not work!');
    }

    if(empty($_POST['currency'])) {
        echo span('Please choose your currency!');
    }

    if($_POST['bank'] == NULL) {
        echo span('Please choose your banking institution');
    }
    //name, email, amount, currency bank
